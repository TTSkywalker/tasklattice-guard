        ...
        {step === 3 ? (
          <WizardSection title={t("guardrailWizard.reviewTitle")} description={t("guardrailWizard.reviewDescription")}>
            <section className="overflow-hidden rounded-xl border bg-card">
              ...
              <ReviewRow label={t("guardrailWizard.runtimeProfile")} value={preview.data ? `${preview.data.engine} · Colang ${preview.data.colang_version}` : t("guardrailWizard.validatingPlan")} mono />
